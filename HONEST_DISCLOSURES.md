...
**Material property disclosure (Feb 2026 audit, updated March 2026):** The simulation previously used incorrect material properties for key materials. Silicon elastic modulus was set to 130 GPa; this was corrected to 170 GPa (proper value for [100] orientation). Organic substrate elastic modulus was set to 25 GPa; this was corrected to 3 GPa (correct value for typical BT/ABF organic substrates). Both corrections were applied across all solver and calibration scripts in the March 2026 audit.
